...
export class CategoriesController {
  ...
  async getAllCategories() {
    ...
    return plainToInstance(CategoryResponseDto, allCategories, {excludeExtraneousValues:true})
  }
  ...
  async createNewCategory(@Body() createCategoryDto: CreateCategoryDto) {
    ...
    return plainToInstance(CategoryResponseDto, newCategory, {excludeExtraneousValues:true})
  }
}
